---
title: "imagefluency"
subtitle: "Image Statistics Based on Processing Fluency"
...
csl: http://www.zotero.org/styles/springer-socpsych-brackets
link-citations: yes
---
...
# bike <- system.file("example_images", "bike.jpg", package = "imagefluency")
# berries <- system.file("example_images", "berries.jpg", package = "imagefluency")
# bridge <- system.file("example_images", "bridge.jpg", package = "imagefluency")
# fireworks <- system.file("example_images", "fireworks.jpg", package = "imagefluency")
# office <- system.file("example_images", "office.jpg", package = "imagefluency")
# rails <- system.file("example_images", "rails.jpg", package = "imagefluency")
# romanesco <- system.file("example_images", "romanesco.jpg", package = "imagefluency")
# sky <- system.file("example_images", "sky.jpg", package = "imagefluency")
# trees <- system.file("example_images", "trees.jpg", package = "imagefluency")
# valley_green <- system.file("example_images", "valley_green.jpg", package = "imagefluency")
# valley_white <- system.file("example_images", "valley_white.jpg", package = "imagefluency")
...
* linking image fluency sorces to outcomes of interest (e.g., how should a typical product packaging look like, do simpler images get more or less attention on a website, ...)
* (interpretable) image features in simple machine learning models, e.g. SVM image classifier


## Theoretical background

The most prevailing explanation for how low-level image features affect humann judgments is based on processing fluency theory [@Reber2004].
